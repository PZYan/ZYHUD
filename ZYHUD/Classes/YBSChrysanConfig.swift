...
public class YBSChrysanConfig {
    ...
    /// 全局默认配置
    public class func `default`() -> YBSChrysanConfig {
        return _default
    }
    
    private static var _default = YBSChrysanConfig(name: "Default")
